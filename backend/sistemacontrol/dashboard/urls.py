...
urlpatterns = [
    ...
    path('registro-empresa/', views.registrar_empresa, name='registrar_empresa'),
    path('login/', views.login_view, name='login'),
    path('recuperar-password/', views.solicitar_recuperacion_password, name='solicitar_recuperacion_password'),
    path('recuperar-password/<uidb64>/<token>/', views.cambiar_password_recuperacion, name='cambiar_password_recuperacion'),
    ...
    path('historial_ventas/descargar/', views.descargar_historial_ventas, name='descargar_historial_ventas'),
    ...
    path('listar_producto/plantilla/', producto.Producto_views.descargar_plantilla_productos, name='descargar_plantilla_productos'),
    path('listar_producto/carga-masiva/', producto.Producto_views.carga_masiva_productos, name='carga_masiva_productos'),
    ...
    path('categorias/plantilla/', views.Categorias_views.descargar_plantilla_categorias, name='descargar_plantilla_categorias'),
    path('categorias/carga-masiva/', views.Categorias_views.carga_masiva_categorias, name='carga_masiva_categorias'),
